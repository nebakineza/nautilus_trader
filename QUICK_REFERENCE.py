...
✅ 4. Backtest Runner
   ...
   Usage: python3 run_institutional_hft_backtest.py [--test]
...
├── validate_hft_backtest.py              ✅ Validation tests
├── INSTITUTIONAL_HFT_BACKTEST.md         ✅ Full documentation
└── backtest_results/                      📊 Output reports
    ├── account_report.csv
    ├── fills_report.csv
    └── positions_report.csv

Data Files:
├── ob_data/BTCUSDT_Spot/                 ✅ 7 days order book data
...
└── tick_data/BTCUSDT_Spot/               ✅ ~127k trades
...
Full Backtest:
   1. Run full day: python3 run_institutional_hft_backtest.py
...
Debugging:
   1. Check backtest_results/ CSV files for issues
