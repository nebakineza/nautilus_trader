...
class TestPersistenceStreaming:
    ...
    def test_convert_stream_to_data_preserves_feather_schema_in_parquet(
        ...
        assert parquet_table.schema.names == transformed_feather_table.schema.names
        assert parquet_table.schema.metadata == transformed_feather_table.schema.metadata
