...
pairs = [
    ...
    },
    {
        ...
        "min_order_qty": Decimal("0.015"),
        "max_position_qty": Decimal("0.2"),
        "guard_threshold_bps": Decimal("10.0"),
...
for pair in pairs:
    ...
    config_strategy = LeadLagMMv3Config(
        ...
        min_balance_ratio=Decimal("0.90"),
        ofi_enabled=pair.get("ofi_enabled", True),
        ofi_max_bps=pair.get("ofi_max_bps", Decimal("2.0")),
        ofi_depth=10,
        ...
        min_order_qty=pair.get("min_order_qty", pair["order_qty"] * Decimal("0.25")),
