"""Run ONDO with v007 FORTRESS - ULTRA SAFE Profile.

ONDO was showing only +14.5 bps avg - needs much wider spreads.
Guardian triggered 4 times - very volatile pair.
"""
...
def main():
    ...
    strategy_config = LeadLagMMv7FortressConfig(
        ...
        realized_spread_min_bps=25.0,  # Require 25 bps profit
    ...
    node.build()
    print(f">>> STARTING {SYMBOL} v007 FORTRESS (ULTRA SAFE: 130bps base)")
    try:
        node.run()
    finally:
        node.dispose()
