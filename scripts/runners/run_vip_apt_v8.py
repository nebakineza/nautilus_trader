"""Run APT with v008 TIMEKEEPER - Inventory Age Management.
...
SYMBOL = "APTUSDT"
STRATEGY_ID = "VIP-APT-V8"
BYBIT_API_KEY = os.environ["BYBIT_API_KEY_MAINACC_10"]
BYBIT_API_SECRET = os.environ["BYBIT_API_SECRET_MAINACC_10"]
...
def main():
    ...
    # APT: Good in v7 (+16.7 bps) - standard settings
