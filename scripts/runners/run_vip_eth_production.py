#!/usr/bin/env python3
"""VIP ETH production runner using LeadLagMMv3Primer.

Usage:
  /home/seb/nebakineza/nautilus_trader/.venv/bin/python run_vip_eth_production.py
"""
...
TRADER_ID = os.getenv("TRADER_ID", "VIP1-PRODUCTION-ETH")


# ETH configuration based on live trading data showing +$501 profit
PAIRS: list[dict[str, object]] = [
    {
        "symbol": "ETHUSDT",
        "order_qty": Decimal("0.02"),  # ~$60 per order at $3000/ETH
        "min_order_qty": Decimal("0.01"),
        "max_position_qty": Decimal("0.5"),  # Max $1500 position
        "guard_threshold_bps": Decimal("10.0"),
        "spread_bps": Decimal("8.0"),  # Tighter spread for ETH
        "min_profit_bps": Decimal("0.5"),
        "global_guard_id": None,
        "refresh_interval": 2000,
        "refresh_offset": 0,
        "liquidity_high_qty": Decimal("50.0"),
