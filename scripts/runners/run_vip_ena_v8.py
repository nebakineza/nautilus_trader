"""Run ENA with v008 TIMEKEEPER - Inventory Age Management.
...
def main():
    ...
    # ENA: Good performer (+52.9 bps) but keep ultra-safe profile
    strategy_config = LeadLagMMv8TimekeeperConfig(
        ...
        min_order_qty=25.0,
        spread_bps=100.0,  # Keep wider - was ultra_safe in v7
        ...
        dynamic_spread_min_bps=60.0,  # Higher min
