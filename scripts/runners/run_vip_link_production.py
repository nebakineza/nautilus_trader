#!/usr/bin/env python3
"""VIP LINK production runner using LeadLagMMv3Primer.

Usage:
  /home/seb/nebakineza/nautilus_trader/.venv/bin/python run_vip_link_production.py
"""
...
TRADER_ID = os.getenv("TRADER_ID", "VIP1-PRODUCTION-LINK")


# LINK configuration based on live trading data showing +$150 profit with only 5 trades
# Live data: ~4.6 LINK per order, profitable at $10.66-$10.80 range
PAIRS: list[dict[str, object]] = [
    {
        "symbol": "LINKUSDT",
        "order_qty": Decimal("5.0"),  # Match live trading size
        "min_order_qty": Decimal("2.5"),
        "max_position_qty": Decimal("50.0"),
        "guard_threshold_bps": Decimal("12.0"),
        "spread_bps": Decimal("12.0"),  # Tighter for LINK
