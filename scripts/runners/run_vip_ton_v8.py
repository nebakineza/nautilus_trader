"""Run TON with v008 TIMEKEEPER - Inventory Age Management.
...
SYMBOL = "TONUSDT"
STRATEGY_ID = "VIP-TON-V8"
BYBIT_API_KEY = os.environ["BYBIT_API_KEY_MAINACC_08"]
BYBIT_API_SECRET = os.environ["BYBIT_API_SECRET_MAINACC_08"]
...
def main():
    ...
    # TON: Lost in v7 (-52.7 bps) - faster exit
    strategy_config = LeadLagMMv8TimekeeperConfig(
        ...
        entry_quality_max_trend_strength=0.40,
