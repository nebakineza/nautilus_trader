"""Run NEAR with v007 FORTRESS - SAFE Profile.

NEAR showing +47.4 bps avg - excellent performance.
"""
...
def main():
    ...
    # NEAR: +47.4 bps avg - SAFE profile (excellent performance)
